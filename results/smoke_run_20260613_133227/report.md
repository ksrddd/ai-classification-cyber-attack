# CICIDS2017 -- training run `smoke_run_20260613_133227`
...
| model | accuracy | balanced acc | f1_macro | f1_weighted | CV f1_macro (mean +/- std) | label-shuffle acc |
|---|---|---|---|---|---|---|
| random_forest | 0.9945 | 0.8434 | 0.8492 | 0.9942 | 0.8099 +/- 0.0093 | 0.8055 |
| xgboost | 0.9940 | 0.8433 | 0.8487 | 0.9937 | 0.8727 +/- 0.0550 | 0.8040 |
...
-   - label-shuffle accuracy = 0.8055; chance = 0.1429. Ratio = 5.64x. Shuffle accuracy near chance confirms the pipeline is not leaking labels.
...
-   - label-shuffle accuracy = 0.8040; chance = 0.1429. Ratio = 5.63x. Shuffle accuracy near chance confirms the pipeline is not leaking labels.
